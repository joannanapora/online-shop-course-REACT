  ...
  return (
    <div>
      ...
      <Switch>
        ...
        <Route path='/tools' render={(props) => <Collection  title="TOOLS" id={1} {...props} />}  />
        <Route path='/flowerpots' render={(props) => <Collection title="FLOWERPOTS" id={2}  {...props} />}  />
        ...
        <Route exact path='/checkout' component={CheckoutPage} /><Route exact path='/contact' component={Contact} />
